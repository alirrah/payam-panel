...
const items = [
    getItem('پیشخوان ها', 'sub1', <Badge count={20} offset={[20, -5]}>
        <DashboardOutlined />
    </Badge>, [
        getItem('Option 1', '1'),
        getItem('Option 2', '2'),
    ...
    getItem('گزارش ها', 'sub2', <Badge count={2} offset={[20, -5]}>
        <FundOutlined />
    </Badge>, [
        getItem('Option 5', '5'),
        getItem('Option 6', '6'),
    ...
    getItem('حوادث', 'sub4', <Badge count={0} offset={[20, -5]}>
        <AimOutlined />
    </Badge>, [
        getItem('Option 9', '9'),
    ...
    getItem('رویدادها', 'sub5', <Badge count={9990} offset={[20, -5]}>
    ...
    getItem('دانش', 'sub6', <Badge count={50} offset={[20, -5]}>
        <BulbOutlined />
    </Badge>, [
        getItem('Option 9', '17'),
    ...
    getItem('محیط', 'sub7', <Badge count={10} offset={[20, -5]}>
    ...
    getItem('تنظیمات', 'sub8', <Badge count={0} offset={[20, -5]}>
        <SettingOutlined />
    </Badge>, [
        getItem('Option 9', '25'),
